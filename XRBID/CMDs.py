...
def FitSED(df, instrument, idheader, photheads=False, errorheads=False, fittype="wls", min_models=1, min_measures=2, input_model=False, model_header_index=13, plotSED=True, showHR=False): 
